...
export const BlockChainSec = () => {
  ...
  return (
    <div className="mt-12 xs:mt-16 sm:mt-20 md:mt-[110px] lg:mt-[160px] overflow-hidden container max-w-[1920px]">
      ...
      <p className=" font-Poppins font-normal text-sm sm:text-base leading-[25px] text-[#B7B7B7] text-center max-w-[997px] mx-auto mt-2 xs:mt-3 md:mt-4">Nexai is an advanced home assistant that will revolutionize the way we interact with our smart devices at home. Powered by sophisticated artificial intelligence, it leverages blockchain technology to offer a secure and efficient user experience.</p>
      <h2 className=" font-Recharge font-bold text-base sm:text-xl leading-8 text-white max-w-[684px] text-center mx-auto mt-6 sm:mt-10 md:mt-[60px] lg:mt-[96px]">By building the software on blockchain, Nexai provides the followingadvantages</h2>
        <Slider className="lg:ml-[10%] pt-8 sm:pt-10 md:pt-[60px] max-lg:container !max-w-[1340px] 2xl:max-w-[1440px]" {...settings}>
          {slides.map((slideContent, index) => (
            <div className={`w-full max-w-[300px] min-h-[300px] md:max-w-[367px] md:min-h-[367px] bg-[url(./assets/png/poliganblockchain.png)] bg-cover bg-center bg-no-repeat md:bg-[100%,100%] duration-300 hover:scale-90 ${index % 2 === 0 ? "" : "mt-10 sm:mt-16 md:mt-20"}`} key={slideContent.id}>
