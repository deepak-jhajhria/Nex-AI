const UniqueSecCard = (props: { svg: any; title: string; para: string }) => {
  return (
    <div className="bg-white rounded-2xl lg:min-h-[400px] w-full sm:max-w-[357px] duration-300 cursor-pointer hover:scale-95 sm:hover:scale-90 hover:shadow-[0_0_10px_1px_#4FEBF6]">
