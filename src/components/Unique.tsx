  ...
  return (
    <div className="border border-[#FCFCFC] rounded-[32px] min-h-[800px] mx-[50px] mt-[120px] bg-[url(./assets/png/uniquesecbg.png)] bg-blend-hue bg-no-repeat bg-cover bg-center">
      <div className="container max-w-[1140px] relative">
        <h2 className="font-bold font-Recharge text-[40px] leading-[50px] text-[#FCFCFC] text-center mt-20">
          Unique features
        </h2>
        <p className="text-base font-normal text-white text-center max-w-[397px] mx-auto font-Poppins opacity-70 mt-[10px]">
        ...
        <div className="grid justify-between w-full grid-cols-2 mt-20 h-[546px] overflow-y-scroll">
          ...
          <div className="-mt-[100px]">
            <UniqueSecCard
              svg={<UniSecIconThird />}
              title="Autonomous and Natural Language Communication"
          ...
          <div className="mt-[200px] flex justify-end">
            <UniqueSecCard
              svg={<UniSecIconFourth />}
              title="Intelligent Contextual Awareness"
