...
export const Footer = () => {
  return (
    <footer className="w-full sm:min-h-[492px] bg-[url(./assets/images/footerbg.webp)] bg-center bg-cover bg-no-repeat mt-8 md:mt-12 lg:mt-[89px] relative overflow-x-clip">
      <div className="container max-w-[1140px] pt-[30px]">
        <div className="grid grid-cols-1 md:grid-cols-3 sm:pt-16 md:pt-[90px] lg:pt-[150px]">
          ...
          <div className="flex justify-between mt-9 xs:mt-10 md:-ml-10 md:-mt-9 lg:ml-0">
