...
export const Footer = () => {
  return (
    <footer className="w-full min-h-[492px] bg-[url(./assets/png/footerbg.png)] bg-center bg-cover bg-no-repeat">
        ...
        <div className="grid grid-cols-3 pt-[150px]">
          ...
          <div className="flex justify-between -mt-9">
            <ul className="flex flex-col gap-5">
              <li className="text-lg font-bold text-white font-Recharge">Quick links</li>
              <li><a className="text-base font-bold text-white font-Recharge opacity-70" href="/"> Home</a></li>
              <li><a className="text-base font-bold text-white font-Recharge opacity-70" href="/"> Home</a></li>
              <li><a className="text-base font-bold text-white font-Recharge opacity-70" href="/"> Home</a></li>
              <li><a className="text-base font-bold text-white font-Recharge opacity-70" href="/"> Home</a></li>
              <li><a className="text-base font-bold text-white font-Recharge opacity-70" href="/"> Home</a></li>
      ...
      <p className="py-5 text-base font-bold text-white font-Recharge opacity-70 mt-[30px] text-center border-t-[#6A6F6F] border-t-[2px]">@Copyright.nexai</p>
      </div>
    </footer>
  );
};
